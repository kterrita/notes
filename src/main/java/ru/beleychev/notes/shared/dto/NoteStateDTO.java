 ...
 */
public class NoteStateDTO implements IsSerializable {
    private Long id;
    ...
    public NoteStateDTO(Long id) {
        this.id = id;
    }

    public NoteStateDTO(Long id, String description, String systemName, Set<NoteDTO> notes) {
        this.id = id;
